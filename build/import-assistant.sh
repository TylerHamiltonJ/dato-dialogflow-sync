...
# Prepare content to import Dialogflow agent and import agent
...
curl https://dialogflow.googleapis.com/v2/projects/$PROJECT_ID/agent:import -X POST -H "Authorization: Bearer $AUTHORIZATION" -H "Accept: application/json" -H "Content-Type: application/json" --compressed --data-binary @- <<CURL_DATA
